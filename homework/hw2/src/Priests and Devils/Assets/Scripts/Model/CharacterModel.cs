...
public class CharacterModel
{
    ...
    public CharacterModel(string type)
    {
        ...
        if (type == "priest")
        {
            character = Object.Instantiate(Resources.Load("Prefabs/Priest", typeof(GameObject))) as GameObject;
            characterType = 0;
        }
        else
        {
            character = Object.Instantiate(Resources.Load("Prefabs/Devil", typeof(GameObject))) as GameObject;
            characterType = 1;
        }
        //增加两个脚本在牧师/魔鬼上
